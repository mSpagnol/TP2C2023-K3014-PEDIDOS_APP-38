...
IF OBJECT_ID('PEDIDOS_APP.CUPON_DESCUENTO', 'U') IS NOT NULL
	DROP TABLE PEDIDOS_APP.CUPON_DESCUENTO
GO
...
IF OBJECT_ID('PEDIDOS_APP.MIGRAR_CUPON_DESCUENTO') IS NOT NULL
	DROP PROCEDURE PEDIDOS_APP.MIGRAR_CUPON_DESCUENTO
GO
...
CREATE TABLE PEDIDOS_APP.CUPON_DESCUENTO(
...
ALTER TABLE PEDIDOS_APP.USUARIO_X_CUPON ADD CONSTRAINT FK_USUARIO_CUPON_NRO FOREIGN KEY (CUPON_CODIGO) REFERENCES PEDIDOS_APP.CUPON_DESCUENTO(CUPON_CODIGO)
GO
...
CREATE PROCEDURE PEDIDOS_APP.MIGRAR_CUPON_DESCUENTO
AS
BEGIN 
	INSERT INTO PEDIDOS_APP.CUPON_DESCUENTO
...
BEGIN
	INSERT INTO PEDIDOS_APP.USUARIO_X_CUPON
		...
		FROM gd_esquema.Maestra m
		JOIN USUARIO u on u.USUARIO_DNI = m.USUARIO_DNI
		JOIN CUPON_DESCUENTO c on c.CUPON_NRO = m.CUPON_NRO
		WHERE m.USUARIO_DNI IS NOT NULL
END
GO
...
EXEC PEDIDOS_APP.MIGRAR_CUPON_DESCUENTO
...
SELECT *
 FROM PEDIDOS_APP.LOCAL_LOCALIDAD
