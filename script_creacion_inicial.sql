...
ALTER TABLE PEDIDOS_APP.LOCAL ADD CONSTRAINT FK_HORARIO_LOCAL_NRO FOREIGN KEY (HORARIO_LOCAL_NRO) REFERENCES PEDIDOS_APP.HORARIO_LOCAL(HORARIO_LOCAL_NRO)

ALTER TABLE PEDIDOS_APP.REPARTIDOR ADD CONSTRAINT FK_TIPO_MOVILIDAD_COD FOREIGN KEY (TIPO_MOVILIDAD_COD) REFERENCES PEDIDOS_APP.TIPO_MOVILIDAD(TIPO_MOVILIDAD_COD)
GO