...
IF OBJECT_ID ('PEDIDOS_APP.FK_LOCAL_CATEGORIA_ID', 'F') IS NOT NULL
	ALTER TABLE PEDIDOS_APP.LOCAL_CATEGORIA DROP CONSTRAINT FK_LOCAL_CATEGORIA_ID
GO

IF OBJECT_ID ('PEDIDOS_APP.FK_LOCAL_TIPO_ID', 'F') IS NOT NULL
	ALTER TABLE PEDIDOS_APP.LOCAL_TIPO DROP CONSTRAINT FK_LOCAL_TIPO_ID
GO
...
IF OBJECT_ID ('BI_PEDIDOS_APP.FX_CALCULAR_CATEGORIA') IS NOT NULL
	DROP FUNCTION BI_PEDIDOS_APP.FX_CALCULAR_CATEGORIA
GO
