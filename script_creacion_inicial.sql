...
BEGIN
	INSERT INTO PEDIDOS_APP.PEDIDO
		...
		PEDIDO_TOTAL_CUPONES, PEDIDO_TOTAL_SERVICIO, PEDIDO_OBSERV, PEDIDO_FECHA, PEDIDO_FECHA_ENTREGA, PEDIDO_TIEMPO_ESTIMADO_ENTREGA, PEDIDO_CALIFICACION, MEDIO_DE_PAGO_NRO_TARJETA, LOCAL_NOMBRE,
		USUARIO_DNI)
		SELECT DISTINCT m.PEDIDO_NRO, m.PEDIDO_TOTAL_PRODUCTOS, m.PEDIDO_TARIFA_SERVICIO,m.PEDIDO_TOTAL_CUPONES, m.PEDIDO_TOTAL_SERVICIO,
						m.PEDIDO_OBSERV, m.PEDIDO_FECHA, m.PEDIDO_FECHA_ENTREGA, m.PEDIDO_TIEMPO_ESTIMADO_ENTREGA, m.PEDIDO_CALIFICACION, mp.MEDIO_PAGO_NRO_TARJETA, l.LOCAL_NOMBRE, u.USUARIO_DNI
		FROM gd_esquema.Maestra m
		JOIN USUARIO u on u.USUARIO_DNI = m.USUARIO_DNI
...
BEGIN
	...
	SELECT DISTINCT p.PEDIDO_NRO, m.PRODUCTO_CANTIDAD, pl.PRODUCTO_LOCAL_CODIGO, pl.PRODUCTO_LOCAL_PRECIO
	FROM gd_esquema.Maestra m
	JOIN PEDIDO p on p.PEDIDO_NRO = m.PEDIDO_NRO
...
--SELECT * FROM PEDIDOS_APP.PEDIDO