...
BEGIN
	INSERT INTO PEDIDOS_APP.PEDIDO
		...
		USUARIO_DNI, PEDIDO_ESTADO,PEDIDO_FECHA_ENTREGA, REPARTIDOR_DNI)
		SELECT DISTINCT m.PEDIDO_NRO, m.PEDIDO_TOTAL_PRODUCTOS, m.PEDIDO_TARIFA_SERVICIO,m.PEDIDO_TOTAL_CUPONES, m.PEDIDO_TOTAL_SERVICIO,
						m.PEDIDO_OBSERV, m.PEDIDO_FECHA,m.PEDIDO_TIEMPO_ESTIMADO_ENTREGA, m.PEDIDO_CALIFICACION, mp.MEDIO_PAGO_NRO_TARJETA, l.LOCAL_NOMBRE, u.USUARIO_DNI, m.PEDIDO_ESTADO,m.PEDIDO_FECHA_ENTREGA , m.REPARTIDOR_DNI
		FROM gd_esquema.Maestra m
		JOIN USUARIO u on u.USUARIO_DNI = m.USUARIO_DNI
