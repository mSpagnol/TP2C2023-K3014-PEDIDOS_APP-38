...
BEGIN
	INSERT INTO PEDIDOS_APP.RECLAMO
		...
		SELECT DISTINCT m.RECLAMO_NRO, m.RECLAMO_CALIFICACION, m.RECLAMO_DESCRIPCION, m.RECLAMO_ESTADO,m.RECLAMO_FECHA, m.RECLAMO_FECHA, m.RECLAMO_SOLUCION, m.RECLAMO_TIPO, p.PEDIDO_NRO, u.USUARIO_DNI
		FROM gd_esquema.Maestra m
		JOIN PEDIDO p on p.PEDIDO_NRO = m.PEDIDO_NRO
		JOIN USUARIO u on u.USUARIO_DNI = m.USUARIO_DNI
