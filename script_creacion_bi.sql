...
BEGIN
	...
	CANTIDAD_PEDIDOS)
		...
		AVG(DATEDIFF(MINUTE, p.PEDIDO_FECHA, p.PEDIDO_FECHA_ENTREGA)),
        ...
        l.LOCAL_CATEGORIA, t.ID_TIEMPO, tm.TIPO_MOVILIDAD_ID, tmp.TIPO_MEDIO_DE_PAGO_ID
END
GO
