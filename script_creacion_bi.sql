...
BEGIN
	...
	join BI_PEDIDOS_APP.BI_LOCAL_TIPO bt on bt.LOCAL_TIPO_DESCRIPCION = l.LOCAL_TIPO
END
GO
...
BEGIN
	...
	CANTIDAD_PEDIDOS)
		...
		join BI_PEDIDOS_APP.BI_LOCAL_CATEGORIA cl on cl.LOCAL_CATEGORIA = l.LOCAL_CATEGORIA
        ...
        l.LOCAL_CATEGORIA, t.ID_TIEMPO, tm.TIPO_MOVILIDAD_ID, tmp.TIPO_MEDIO_DE_PAGO_ID,cl.LOCAL_CATEGORIA_ID
END
GO
