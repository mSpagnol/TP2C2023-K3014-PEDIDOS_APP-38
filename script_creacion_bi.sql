...
/*
ALTER TABLE BI_PEDIDOS_APP.BI_HECHO_RECLAMO ADD CONSTRAINT FK_RECLAMO_ESTADO FOREIGN KEY (ID_RECLAMO) REFERENCES BI_PEDIDOS_APP.BI_ESTADO_RECLAMO(ESTADO_RECLAMO_ID)
GO
...
AS
	SELECT
			tp.PAQUETE_TIPO,
			AVG(em.ENVIO_MENSAJERIA_VALOR_ASEGURADO) as MONTO_MENSUAL_CUPONES,
			t.TIEMPO_MES
		FROM BI_PEDIDOS_APP.BI_HECHO_ENVIO_MENSAJERIA em
