...
BEGIN
	...
	CANTIDAD_PEDIDOS)
		...
		join BI_PEDIDOS_APP.BI_DIA d on d.ID_DIA = DATENAME(WEEKDAY, p.PEDIDO_FECHA)
...
SELECT *
FROM BI_PEDIDOS_APP.BI_HECHO_RECLAMO

SELECt * from BI_PEDIDOS_APP.BI_LOCAL_CATEGORIA