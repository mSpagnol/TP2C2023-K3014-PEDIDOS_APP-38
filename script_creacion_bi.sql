...
BEGIN
	...
	PEDIDO_FECHA_ENTREGA*/)
		...
		join BI_TIEMPO t on DATEPART(month,p.PEDIDO_FECHA)=t.TIEMPO_MES and DATEPART(YEAR,p.PEDIDO_FECHA) = t.TIEMPO_ANIO
END
GO
...
CREATE VIEW BI_PEDIDOS_APP.GANANCIAS_MENSUALES_CANAL_VENTA
AS
	SELECT D.DIA_SEMANA,RH.RANGO_HORARIO 
	...
	GROUP BY T.TIEMPO_ANIO, RH.RANGO_HORARIO, V.ID_CANAL_VENTA, CV.CANAL_DESC
GO
GO
