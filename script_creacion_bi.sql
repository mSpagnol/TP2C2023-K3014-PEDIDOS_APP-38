...
CREATE TABLE BI_PEDIDOS_APP.BI_HECHO_ENVIO_MENSAJERIA(
	...
	ID_DIA nvarchar(20), -- CREAR FK
	ID_RANGO_HORARIO INT, -- CREAR FK
	ID_TIEMPO INT, --CREAR FK
	ID_ESTADO_MENSAJERIA INT, -- CREAR FK 
	RANGO_ETARIO_USUARIO INT, -- CREAR FK
	RANGO_ETARIO_REPARTIDOR INT, -- CREAR FK
	PAQUETE_NRO INT 
);
GO
...
AS
	BEGIN 
		...
		SELECT 
			...
			DATENAME(WEEKDAY, e.ENVIO_MENSAJERIA_FECHA),
