...
/* DROP TABLES */
IF OBJECT_ID('PEDIDOS_APP.DIM_ESTADOS_PEDIDOS', 'U') IS NOT NULL
	DROP TABLE BI_PEDIDOS_APP.DIM_ESTADOS_PEDIDOS
GO

IF OBJECT_ID('PEDIDOS_APP.DIM_ESTADOS_RECLAMOS', 'U') IS NOT NULL
	DROP TABLE BI_PEDIDOS_APP.DIM_ESTADOS_RECLAMOS
GO

IF OBJECT_ID('PEDIDOS_APP.DIM_ESTADOS_ENVIOS_MENSAJERIA', 'U') IS NOT NULL
	DROP TABLE BI_PEDIDOS_APP.DIM_ESTADOS_ENVIOS_MENSAJERIA
GO
...
/* CREANDO TABLAS */
CREATE TABLE BI_PEDIDOS_APP.DIM_ESTADOS_PEDIDOS(
...
GO
CREATE TABLE BI_PEDIDOS_APP.DIM_ESTADOS_ENVIOS_MENSAJERIA(
...
GO
CREATE TABLE BI_PEDIDOS_APP.DIM_ESTADOS_RECLAMOS(
